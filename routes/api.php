...
Route::middleware('auth:api')->get('/categories/{categoryId}', [CategoryController::class, 'show']);
...
Route::middleware('auth:api')->get('/products/{productId}', [ProductController::class, 'show']);
...
Route::middleware('auth:api')->get('/categories/{categoryId}/products', [CategoryProductController::class, 'index']);
